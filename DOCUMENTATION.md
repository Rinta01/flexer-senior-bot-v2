...
> Умный Telegram-бот для автоматического управления ротацией "дежурных" в дружеских группах.  
> Еженедельный выбор, система подтверждений, управление активностями и полный цикл без повторений.
...
- ✅ **Автоматическое назначение дежурных** - Еженедельный выбор случайного дежурного по расписанию
...
- ✅ **Статусы дежурных** - Отслеживание состояния (PENDING, CONFIRMED, DECLINED, SKIPPED)
- ✅ **Ручной выбор** - Команда `/force_pick @username` для назначения конкретного пользователя
...
| `/force_pick @username` | Назначить конкретного пользователя дежурным на текущую неделю | Все в группе           |
